...
- Integrated Machine Learning & Computer Vision  
- Recommends places based on user preferences & images  

---

### 🎬 Anime Recommendation System
- Built using Scikit-learn  
- Dataset with 10k+ ratings  
...
- Cisco Packet Tracer  
- Implemented routing protocols (OSPF / EIGRP / RIP)  
- Worked with NAT & Firewalls  
